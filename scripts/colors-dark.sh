...
sed -i -e 's/bg = .*/bg = #1F1F1F/g' $PDIR/config.ini
sed -i -e 's/fg = .*/fg = #FFFFFF/g' $PDIR/config.ini
sed -i -e 's/fg-alt = .*/fg-alt = #B0A9AA/g' $PDIR/config.ini
sed -i -e 's/acolor = .*/acolor = #FFFFFF/g' $PDIR/config.ini
sed -i -e 's/txt = .*/txt = #2C2C2C/g' $PDIR/config.ini
sed -i -e 's/shade1 = .*/shade1 = #870E28/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #AD1536/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #C2173C/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #D91A43/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #E81E4A/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #ED4065/g' $PDIR/config.ini
sed -i -e 's/shade7 = .*/shade7 = #F06283/g' $PDIR/config.ini
sed -i -e 's/shade8 = .*/shade8 = #F590A6/g' $PDIR/config.ini
sed -i -e 's/HIGHLIGHT_BACKGROUND=.*/HIGHLIGHT_BACKGROUND="#870E28"/g' $PDIR/scripts/menu
sed -i -e 's/HIGHLIGHT_BACKGROUND=.*/HIGHLIGHT_BACKGROUND="#870E28"/g' $PDIR/scripts/menu_full
sed -i -e 's/HIGHLIGHT_BACKGROUND=.*/HIGHLIGHT_BACKGROUND="#870E28"/g' $PDIR/scripts/sysmenu
sed -i -e 's/HIGHLIGHT_BACKGROUND=.*/HIGHLIGHT_BACKGROUND="#870E28"/g' $PDIR/scripts/color-switch.sh
# Restarting polybar
$LAUNCH &
